...
public class Utilidades {
    ...
    // Sentencia SQL
    public static final String CREAR_TABLA_CAJAS = "CREATE TABLE "+TABLA_CAJAS+" ("+CAMPO_IDCAJA+" INTEGER PRIMARY KEY AUTOINCREMENT, "+CAMPO_CAJA_IDPERFIL+" TEXT,"+CAMPO_CAJA_NOMBRE+" TEXT, "+CAMPO_CAJA_PORCENTAJE+" INT, "+CAMPO_CAJA_MONTO+" DOUBLE,"+CAMPO_CAJA_DESCRIPCION+" TEXT)";
    ...
    // Sentencia SQL
    public static final String CREAR_TABLA_MOVIMIENTOS = "CREATE TABLE "+TABLA_MOVIMIENTOS+" ("+CAMPO_IDMOVIMIENTOS+" INTEGER PRIMARY KEY AUTOINCREMENT, "+CAMPO_MOVIMIENTO_IDPERFIL+" INTEGER,"+CAMPO_MOVIMIENTO_MONTO+" DOUBLE, "+CAMPO_MOVIMIENTO_INGEGR+" TEXT, "+CAMPO_MOVIMIENTO_CAJA+" INT,"+CAMPO_MOVIMIENTO_DESCRIPCION+" TEXT, "+CAMPO_MOVIMIENTO_FECHA+"TEXT)";
